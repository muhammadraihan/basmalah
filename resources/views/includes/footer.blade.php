    ...
    <div class="container py-5">
        <div class="row g-5">
            ...
            <div class="col-lg-4 col-md-6">
                ...
                <p>Masukkan email kamu untuk mengikuti info dari Basmalah</p>
...
<div class="container-fluid copyright bg-dark py-4">
    <div class="container text-center">
        <p class="mb-2">Copyright &copy; <a class="fw-semi-bold" href="#">Basmalah Tour & Travel</a>, All Right Reserved.
        </p>
        <!--/*** This template is free as long as you keep the footer author’s credit link/attribution link/backlink. If you'd like to use the template without the footer author’s credit link/attribution link/backlink, you can purchase the Credit Removal License from "https://htmlcodex.com/credit-removal". Thank you for your support. ***/-->
        <p class="mb-0">Designed By <a class="fw-semi-bold" href="https://wbaindonesia.com">WBA Indonesia</a>
    </div>
</div>
<!-- Copyright End -->