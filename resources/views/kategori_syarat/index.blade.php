...
@section('title', 'Kategori Syarat Management')
...
<div class="subheader">
    <h1 class="subheader-title">
        <i class='subheader-icon fal fa-users'></i> Module: <span class='fw-300'>Kategori Syarat </span>
        <small>
            Module for manage Kategori Syarat.
        </small>
    </h1>
</div>
<div class="row">
    <div class="col-xl-12">
        <div id="panel-1" class="panel">
            <div class="panel-hdr">
            <h2>
                    Kategori Syarat  <span class="fw-300"><i>List</i></span>
                </h2>
                <div class="panel-toolbar">
                    <a class="nav-link active" href="{{route('kategori_syarat.create')}}"><i class="fal fa-plus-circle">
                        </i>
...
<script>
    $(document).ready(function(){
       ...
       var table = $('#datatable').DataTable({
            ...
            "order": [[ 0, "asc" ]],
            "ajax":{
                url:'{{route('kategori_syarat.index')}}',
                type : "GET",
                dataType: 'json',
                error: function(data){
                    console.log(data);
