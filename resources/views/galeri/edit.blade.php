...
<div class="row">
    <div class="col-xl-6">
        <div id="panel-1" class="panel">
            <div class="panel-hdr">
            <h2>Edit <span class="fw-300"><i>{{$galeri->judul}}</i></span></h2>
                <div class="panel-toolbar">
                    <a class="nav-link active" href="{{route('galeri.index')}}"><i class="fal fa-arrow-alt-left">
                        </i>
            ...
            <div class="panel-container show">
                <div class="panel-content">
                    ...
                    @endif
                    {!! Form::open(['route' => ['galeri.update',$galeri->uuid],'method' => 'PUT','class' =>
                    'needs-validation','novalidate', 'enctype' => 'multipart/form-data']) !!}
                    <div class="form-group col-md-4 mb-3">
                        {{ Form::label('judul','Judul',['class' => 'required form-label'])}}
                        {{ Form::text('judul',$galeri->judul,['placeholder' => 'Judul','class' => 'form-control '.($errors->has('judul') ? 'is-invalid':''),'required', 'autocomplete' => 'off'])}}
                        @if ($errors->has('judul'))
                    ...
                    <div class="form-group col-md-4 mb-3">
                        ...
                        {{ Form::text('keterangan',$galeri->keterangan,['placeholder' => 'Keterangan','class' => 'form-control '.($errors->has('keterangan') ? 'is-invalid':''),'required', 'autocomplete' => 'off'])}}
                    ...
                    <div class="form-group col-md-4 mb-3">
                        ...
                        <input type="hidden" name="oldImage" value="{{ $galeri->photo }}"> 
                        @if ($galeri->photo)
                            <img src="{{ asset('photo/' . $galeri->photo) }}" class="img-preview img-fluid mb-3 col-sm-5 d-block">
                        @else
