...
<div class="row">
    <div class="col-xl-6">
        <div id="panel-1" class="panel">
            <div class="panel-hdr">
                <h2>Add New <span class="fw-300"><i>Download </i></span></h2>
            ...
            <div class="panel-container show">
                <div class="panel-content">
                    ...
                    {!! Form::open(['route' => 'download.store','id'=>'forms','method' => 'POST','class' =>
                    ...
                    <div class="form-group col-md-4 mb-3">
                        ...
                        {{ Form::text('tanggal',null,['placeholder' => 'Tanggal Keberangkatan','class' => 'tanggal form-control '.($errors->has('tgl_surat') ? 'is-invalid':''),'required', 'autocomplete' => 'off'])}}
                    ...
                    <div class="form-group col-md-4 mb-3">
                        ...
                        {{ Form::text('link',null,['placeholder' => 'Link Download','class' => 'form-control '.($errors->has('link') ? 'is-invalid':''),'required', 'autocomplete' => 'off'])}}
                        @if ($errors->has('link'))
