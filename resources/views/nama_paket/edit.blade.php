...
<div class="row">
    <div class="col-xl-6">
        <div id="panel-1" class="panel">
            <div class="panel-hdr">
            <h2>Edit <span class="fw-300"><i>{{$namapaket->name}}</i></span></h2>
                <div class="panel-toolbar">
                    <a class="nav-link active" href="{{route('namapaket.index')}}"><i class="fal fa-arrow-alt-left">
                        </i>
            ...
            <div class="panel-container show">
                <div class="panel-content">
                    ...
                    {!! Form::open(['route' => ['namapaket.update',$namapaket->uuid],'method' => 'PUT','class' =>
                    'needs-validation','novalidate', 'enctype' => 'multipart/form-data']) !!}
                    <div class="form-group col-md-3 mb-3">
                        {{ Form::label('kategori','Kategori',['class' => 'required form-label'])}}
                        {!! Form::select('kategori', $kategori, $namapaket->kategori, ['id' =>
                        'kategori','class' =>
                    ...
                    <div class="form-group col-md-4 mb-3">
                        {{ Form::label('name','Nama Paket',['class' => 'required form-label'])}}
                        {{ Form::text('name',$namapaket->name,['placeholder' => 'Nama Paket','class' => 'form-control '.($errors->has('name') ? 'is-invalid':''),'required', 'autocomplete' => 'off'])}}
                        @if ($errors->has('name'))
