...
<div class="row">
    <div class="col-xl-6">
        <div id="panel-1" class="panel">
            <div class="panel-hdr">
            <h2>Edit <span class="fw-300"><i>{{$cabang->name}}</i></span></h2>
            ...
            <div class="panel-container show">
                <div class="panel-content">
                    ...
                    <div class="form-group col-md-4 mb-3">
                        ...
                        {{ Form::textarea('alamat',$cabang->alamat,['placeholder' => 'Alamat','class' => 'form-control '.($errors->has('alamat') ? 'is-invalid':''),'required', 'autocomplete' => 'off'])}}
                    ...
                    <div class="form-group col-md-4 mb-3">
                        ...
                        {{ Form::text('telp',$cabang->telp,['placeholder' => 'No. Telephone','class' => 'form-control '.($errors->has('telp') ? 'is-invalid':''),'required', 'autocomplete' => 'off'])}}
                        @if ($errors->has('telp'))
                    ...
                    <div class="form-group col-md-4 mb-3">
                        ...
                        {{ Form::text('email',$cabang->email,['placeholder' => 'Email','class' => 'form-control '.($errors->has('email') ? 'is-invalid':''),'required', 'autocomplete' => 'off'])}}
                        @if ($errors->has('email'))
